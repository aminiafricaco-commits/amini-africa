...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_rgba(10,22,40,0.25),transparent_50%)]" />
      ...
      <div className="absolute top-20 right-20 w-96 h-96 rounded-full border border-white/10 animate-float" />
      <div className="absolute bottom-40 right-1/3 w-48 h-48 rounded-full border border-white/10 animate-float" style={{ animationDelay: "-3s" }} />
      <div className="absolute top-1/3 left-10 w-32 h-32 rounded-full bg-white/5 blur-2xl" />
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-40">
        <div className="max-w-4xl">
          ...
          >
            ...
            <span className="text-white/80 font-medium text-xs tracking-widest uppercase">
          ...
          >
            ...
            <span className="block text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-white/80 font-medium mt-2">
              Sub-Saharan Partner
            </span>
          </motion.h1>
          ...
          >
            <Button asChild size="xl" variant="gold" className="bg-white text-primary hover:bg-white/90 shadow-xl shadow-white/30 group">
          ...
          >
            {metrics.map((m) => (
              <div
                key={m.label}
                className="group relative bg-white/[0.04] backdrop-blur-sm rounded-2xl px-5 py-4 border border-white/[0.06] hover:border-white/30 transition-all duration-500"
              >
                ...
                <div className="relative flex items-center gap-3">
                  <div className="flex items-center justify-center w-11 h-11 rounded-xl bg-white/10 border border-white/20 shrink-0 group-hover:bg-white/20 transition-all duration-500">
