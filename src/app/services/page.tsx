      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-12">
          {services.map((service, index) => (
            <div
              key={service.href}
              className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start bg-white rounded-2xl border border-border p-8 lg:p-10 hover:border-primary/20 transition-colors duration-300"
            >
              <div className={index % 2 === 1 ? "lg:order-2" : ""}>
                ...
                <Link
                  href={service.href}
                  className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-lg font-semibold hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/25 active:scale-[0.97] transition-all duration-200"
                >
